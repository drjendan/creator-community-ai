...
export const dashboardNavItems: NavigationItem[] = [
  ...
  { label: "Community Spaces", href: "/dashboard/community", group: tenantNavigationGroups.community, featureKey: "community", permission: "tenant.content.view" },
  ...
  { label: "Branding", href: "/dashboard/branding", group: tenantNavigationGroups.settings, permission: "tenant.settings.manage" },
